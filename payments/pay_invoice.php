...
//  View’dan invoice detaylarını çeker
...
// Ödeme yöntemlerini çekmek için
...
<head>
  ...
  <style>
    ...
    body {
      height: 100%;
      /* Tarayıcı penceresinin tamamını kapsasın */
      margin: 0;
      ...
      background: #e6f0ff;
      /* Sayfanın genel arka plan rengi */
    }
    ...
    main {
      ...
      /* İçindeki çocuk öğeleri (h2, table) dikey dizilir */
      align-items: center;
      /* Bu dikey sütunda çocukları yatayda ortaya alır */
      padding: 30px;
    ...
    main h2 {
      ...
      text-align: center;
      /* Kendisi bulunduğu yatay satırda ortaya hizalar */
      margin-bottom: 20px;
    ...
    main th {
      ...
      /* Başlık hücrelerinin koyu mavi arka planı */
      font-weight: 600;
      /* Kalınlığı biraz azaltılmış bold */
      color: white;
      /* Başlık metni beyaz */
    }
    ...
    .btn-pay:hover {
      background: #0056b3;
      /* Üzerine gelince daha koyu mavi */
    }
  </style>
</head>
