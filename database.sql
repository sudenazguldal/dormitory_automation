...
INSERT INTO `beds` (`bed_id`, `room_id`, `bed_no`) VALUES
(1, 31, 1),
(2, 31, 2),
(3, 32, 1),
(4, 32, 2),
...
INSERT INTO `invoices` (`invoice_id`, `student_id`, `total_amount`, `issue_date`, `due_date`, `status_id`, `method_id`) VALUES
...
INSERT INTO `payments` (`payment_id`, `student_id`, `amount`, `payment_date`, `status_id`, `method_id`) VALUES
...
INSERT INTO `payment_allocations` (`payment_id`, `invoice_id`, `alloc_amount`) VALUES
(4, 365, 40000.00),
(5, 366, 40000.00),
(6, 367, 40000.00),
(7, 368, 40000.00),
...
INSERT INTO `permissions` (`permission_id`, `student_id`, `start_date`, `end_date`, `permissions_type`) VALUES
...
CREATE TABLE `permission_approved_by` (
  `permission_id` int(11) NOT NULL,
...
INSERT INTO `permission_approved_by` (`permission_id`, `user_id`, `approved_at`) VALUES
...
CREATE TABLE `permission_created_by` (
  `permission_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `permission_created_by` (`permission_id`, `user_id`) VALUES
(20, 1),
(21, 1),
(23, 1),
(24, 1);
...
INSERT INTO `room_assignments` (`room_assignments_id`, `student_id`, `bed_id`) VALUES
(2, 4, 5),
(3, 2, 1),
(4, 7, 2),
(5, 1, 10),
...
INSERT INTO `students` (`student_id`, `TC_no`, `first_name`, `last_name`, `birth_date`, `register_date`, `stud_telNo`) VALUES
...
CREATE TABLE `student_entry_logs` (
...
INSERT INTO `student_entry_logs` (`student_entry_log_id`, `student_id`, `security_id`, `action`, `timestamp`) VALUES
...
INSERT INTO `users` (`user_id`, `TC_no`, `password`, `first_name`, `last_name`, `role`) VALUES
...
--
CREATE TABLE `view_active_permissions` (
...
-- (Asıl görünüm için aşağıya bakın)
--
CREATE TABLE `view_pending_permissions` (
`permission_id` int(11)
,`student_name` varchar(101)
,`start_date` date
,`end_date` date
...
-- (Asıl görünüm için aşağıya bakın)
--
CREATE TABLE `view_recent_approvals` (
`permission_id` int(11)
,`student_name` varchar(101)
,`start_date` date
,`end_date` date
...
-- (Asıl görünüm için aşağıya bakın)
--
CREATE TABLE `v_active_invoices` (
`invoice_id` int(11)
,`student_name` varchar(101)
...
-- (Asıl görünüm için aşağıya bakın)
--
CREATE TABLE `v_invoice_details` (
`invoice_id` int(11)
,`student_id` int(11)
,`student_name` varchar(101)
,`total_amount` decimal(10,2)
...
-- (Asıl görünüm için aşağıya bakın)
--
CREATE TABLE `v_monthly_payments` (
`month` varchar(7)
...
-- (Asıl görünüm için aşağıya bakın)
--
CREATE TABLE `v_recent_permissions` (
`permission_id` int(11)
,`start_date` date
,`end_date` date
,`permissions_type` enum('Weekend','Holiday','Medical','Family','Another')
